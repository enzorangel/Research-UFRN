...
set style line 13 lc rgb '#FF6600' dt 1 lw 4.5 pt 6 ps 3.0
set style line 14 lc rgb '#2f2999' dt 1 lw 4.5 pt 6 ps 3.0

	outname = sprintf("inf.tex")

	set out outname


set xl'$\kappa$' font ", 28" offset 0,-1.25,0
set yl'$\beta^{\star}$' font ", 28" offset -2,0,0

set xtics 0.13,0.03,0.66
#set xr[0.72:4.08] 
set ytics 0.05
set yr[0.25:0.7]
...
plot 	'statistics.dat' u ($1/6.2):2:3 with errorbars ls 13 notitle,\
	'statistics.dat' u ($1/6.2):2 with lp ls 13 notitle
