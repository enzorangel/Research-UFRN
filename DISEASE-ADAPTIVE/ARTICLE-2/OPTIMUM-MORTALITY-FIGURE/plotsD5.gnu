...
set style line 13 lc rgb '#4D148C' dt 1 lw 4.5 pt 6 ps 3.0
set style line 14 lc rgb 'yellow' dt 1 lw 4.5 pt 6 ps 3.0
...
set size 1.6, 1.3
#set key at 2.3,0.23 font ",14"

plot 	'statistics.dat' u 1:2:3 with errorbars ls 13 notitle,\
	'statistics.dat' u 1:2 with lp ls 13 notitle
