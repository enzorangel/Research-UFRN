...
set yl'$\tilde{\chi_1}(\%)$' font ", 28" offset -3,0,0
...
set size 1.6, 1.0
set key at 1,1.5 font ",14"

plot 	'statistics-R3.dat' u 1:((($18-0.316288)/0.316288)*100):46 with errorbars ls 4 t'$R=3$',\
	'statistics-R5.dat' u 1:((($18-0.323599)/0.323599)*100):46 with errorbars ls 3 t'$R=5$',\
	'statistics-R3.dat' u 1:((($18-0.316288)/0.316288)*100) with lp ls 4 notitle,\
	'statistics-R5.dat' u 1:((($18-0.323599)/0.323599)*100) with lp ls 3 notitle,\
