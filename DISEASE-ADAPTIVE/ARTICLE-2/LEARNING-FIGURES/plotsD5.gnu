...
set yl'$\tilde{\rho_1}(\%)$' font ", 28" offset -2,0,0
...
set size 1.6, 1.0
set key at 0.2,50 font ",14"

plot 	'statistics-R3.dat' u 1:(((($3+$8)-0.1561369)/0.1561369)*100):31 with errorbars ls 4 t'$R=3$',\
	'statistics-R5.dat' u 1:(((($3+$8)-0.2105691)/0.2105691)*100):31 with errorbars ls 3 t'$R=5$',\
	'statistics-R3.dat' u 1:(((($3+$8)-0.1561369)/0.1561369)*100) with lp ls 4 notitle,\
	'statistics-R5.dat' u 1:(((($3+$8)-0.2105691)/0.2105691)*100) with lp ls 3 notitle,\
