...
#define num_generations 1500 //tempo de simulação
...
#define num_files 10 //número de fotos da simulação
...
#define d6 0.1 // - valor base: 0.2 -- mortality // mortalidade da doença: inicio 0.1 -- variando de 0.8 em 0.8 ---- terminando em 0.9
