...
set xl'$\epsilon$' font ", 24" offset 0,-1.25,0
...
#set xtics .4
#set ytics 4
set key at 4,25 font ",14"

plot    'inset-teste.dat' u 1:2:3 with yerrorbars ls 1 t'1',\
	'inset-teste.dat' u 1:4:5 with yerrorbars ls 2 t'2',\
	'inset-teste.dat' u 1:6:7 with yerrorbars ls 3 t'3',\
        'inset-teste.dat' u 1:2 with lp ls 1 notitle,\
	'inset-teste.dat' u 1:4 with lp ls 2 notitle,\
	'inset-teste.dat' u 1:6 with lp ls 3 notitle,\
