...
set xl'$\alpha$' font ", 24" offset 0,-1.25,0
...
set style line 1 lc rgb '#1E2EDE' dt 1 lw 4.5 pt 6 ps 2.0 #(species 1)
set style line 2 lc rgb '#cfe4fa' dt 1 lw 4.5 pt 6 ps 2.0 #(species 2)
set style line 3 lc rgb '#0b0404' dt 1 lw 4.5 pt 6 ps 2.0 #(species 3)
...
#set xtics .4
#set ytics 4
set key at 1,23 font ",14"

plot    'inset.dat' u 1:2:3 with yerrorbars ls 1 t'1',\
	'inset.dat' u 1:4:5 with yerrorbars ls 2 t'2',\
	'inset.dat' u 1:6:7 with yerrorbars ls 3 t'3',\
        'inset.dat' u 1:2 with lp ls 1 notitle,\
	'inset.dat' u 1:4 with lp ls 2 notitle,\
	'inset.dat' u 1:6 with lp ls 3 notitle,\
