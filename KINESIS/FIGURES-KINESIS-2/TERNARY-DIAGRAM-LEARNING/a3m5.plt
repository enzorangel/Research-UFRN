...
set noxtics
set noytics
set label '$\rho_2$' at 0.12, 0.0636 center tc '#a3b6c9' font ",14"
set label '$\rho_3$' at 0.88, 0.0636 center tc '#0b0404' font ",14"
set label '$\rho_1$' at 0.5, 0.723 center tc '#1E2EDE' font ",14"

set label '$m=0.5$' at 0.5, 0.8 center tc 'black' font ",16"
...
plot "<awk '{print ($3+2*$5)/(2*($3+$4+$5)), sqrt(3)*$3/(2*($3+$4+$5))}' densitiesk2r2-0.5.dat" t '$\alpha$=1.0' with lines ls 9,\
     "<awk '{print ($3+2*$5)/(2*($3+$4+$5)), sqrt(3)*$3/(2*($3+$4+$5))}' densitiesa3m5.dat" t '$\alpha$=0.3' with lines ls 8
