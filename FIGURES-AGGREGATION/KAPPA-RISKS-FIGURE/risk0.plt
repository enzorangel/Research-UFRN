...
set style line 6 lc rgb 'black' lt 1 lw 4.0 pt 5 ps 1.0 #  black	(empty space)
	...
	outname = sprintf("r0.tex")

	set out outname

set label 2 '$R$ = 0.0' at graph 0.385, 0.85 font ',15'

#set key bottom right Right samplen 0 at 0.5, 0.5

set size 1.0, 1.0

plot  'densities0.dat' u 1:5 with lines ls 1 t '1',\
      'densities0.dat' u 1:6 with lines ls 2 t '2',\
      'densities0.dat' u 1:7 with lines ls 3 t '3'
