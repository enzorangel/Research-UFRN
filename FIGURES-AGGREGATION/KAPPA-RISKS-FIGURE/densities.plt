...
set style line 6 lc rgb 'grey' lt 1 lw 4.0 pt 5 ps 1.0 #  black	(empty space)
	...
	outname = sprintf("d0.tex")

	set out outname

set label 'standard' at graph 0.385, 0.85 font ',15'

#set key bottom right Right samplen 0 at 0.5, 0.5

set size 1.0, 1.0

plot  'densitiesR0.dat' u 1:2 with lines ls 1 t '1',\
      'densitiesR0.dat' u 1:3 with lines ls 2 t '2',\
      'densitiesR0.dat' u 1:4 with lines ls 3 t '3'
