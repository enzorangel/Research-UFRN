...
set label '$R$ = 0.0' at graph 0.285, 0.85 font ',15'

#set key bottom right Right samplen 0 at 0.5, 0.5

set size 1.0, 1.0

plot  'densities0.dat' u 1:2 with lines ls 1 t '1',\
      'densities0.dat' u 1:3 with lines ls 2 t '2',\
      'densities0.dat' u 1:4 with lines ls 3 t '3'
