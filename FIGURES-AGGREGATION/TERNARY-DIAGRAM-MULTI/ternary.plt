...
set noxtics
set noytics
set label '$\rho_2$' at 0.12, 0.0636 center tc '#ffb6c1'
set label '$\rho_3$' at 0.88, 0.0636 center tc '#0b0404'
set label '$\rho_1$' at 0.5, 0.723 center tc '#f43169'
...
set style line 2 lc rgb '#f43169' lt 0 lw 1.5 pt 6 #  red	     (species 2)
set style line 3 lc rgb '#ffb6c1' lt 0 lw 1.5 pt 6 #  orange     (species 3)
...
set label '0.25' at 0.85, 0.173 center tc rgb "#f43169"
set label '0.35' at 0.8, 0.260 center tc rgb "#f43169"
set label '0.45' at 0.75, 0.346 center tc rgb "#f43169"
set label '0.55' at 0.7, 0.433 center tc rgb "#f43169"
set label '0.65' at 0.65, 0.520 center tc rgb "#f43169"
set label '0.75' at 0.6, 0.606 center tc rgb "#f43169"
# y
...
set label '0.25' at 0.4, 0.606 center tc rgb "#ffb6c1"
set label '0.35' at 0.35, 0.520 center tc rgb "#ffb6c1"
set label '0.45' at 0.3, 0.433 center tc rgb "#ffb6c1"
set label '0.55' at 0.25, 0.346 center tc rgb "#ffb6c1"
set label '0.65' at 0.2, 0.260 center tc rgb "#ffb6c1"
set label '0.75' at 0.15, 0.173 center tc rgb "#ffb6c1"
...
plot "<awk '{print ($3+2*$5)/(2*($3+$4+$5)), sqrt(3)*$3/(2*($3+$4+$5))}' densitiesk2r2-0.2.dat" t '$\epsilon$=2' with lines ls 9,\
     "<awk '{print ($3+2*$5)/(2*($3+$4+$5)), sqrt(3)*$3/(2*($3+$4+$5))}' densitiesk4r2-0.2.dat" t '$\epsilon$=4' with lines ls 8 
...
set object 1 polygon from 0.15,0.0866 to 0.5,0.693 to 0.85,0.0866 to 0.15,0.0866
set object 1 back fc rgb "#f7f7f7" fillstyle solid 1.0 noborder
...
set style line 5 lc rgb 'grey' lt 0 lw 1.5 pt 6 #  cyan	     (species 5)
set style line 6 lc rgb '#03c04a' lt 3 lw 1.5 pt 2 #  grey	     (empty space)
set style line 8 lc rgb '#496e37' lt 1 lw 3 pt 2 #  kappa-2-radius-2
set style line 9 lc rgb '#ff5d05' lt 1 lw 3 pt 2 #  kappa-4-radius-2
set style line 10 lc rgb 'pink' lt 2 lw 3 pt 2 # kappa-2-radius-4
set style line 11 lc rgb 'gray' lt 1 lw 3 pt 2 # standard
set style line 12 lc rgb 'brown' lt 2 lw 3 pt 2 # kappa-4-radius-4
...
plot "<awk '{print ($3+2*$5)/(2*($3+$4+$5)), sqrt(3)*$3/(2*($3+$4+$5))}' densitiesk2r2-0.5.dat" t '$\epsilon$=2' with lines ls 9,\
     "<awk '{print ($3+2*$5)/(2*($3+$4+$5)), sqrt(3)*$3/(2*($3+$4+$5))}' densitiesk4r2-0.5.dat" t '$\epsilon$=4' with lines ls 8      
...
set object 1 polygon from 0.15,0.0866 to 0.5,0.693 to 0.85,0.0866 to 0.15,0.0866
set object 1 back fc rgb "white" fillstyle solid 1.0 noborder
...
plot "<awk '{print ($3+2*$5)/(2*($3+$4+$5)), sqrt(3)*$3/(2*($3+$4+$5))}' densitiesk2r2-0.8.dat" t '$\epsilon$=2' with lines ls 9,\
     "<awk '{print ($3+2*$5)/(2*($3+$4+$5)), sqrt(3)*$3/(2*($3+$4+$5))}' densitiesk4r2-0.8.dat" t '$\epsilon$=4' with lines ls 8
...
plot "<awk '{print ($3+2*$5)/(2*($3+$4+$5)), sqrt(3)*$3/(2*($3+$4+$5))}' densitiesk2r2-0.2.dat" t 'r=2' with lines ls 9,\
     "<awk '{print ($3+2*$5)/(2*($3+$4+$5)), sqrt(3)*$3/(2*($3+$4+$5))}' densitiesk2r4-0.2.dat" t 'r=4' with lines ls 8     
...
plot "<awk '{print ($3+2*$5)/(2*($3+$4+$5)), sqrt(3)*$3/(2*($3+$4+$5))}' densitiesk2r2-0.5.dat" t 'r=2' with lines ls 9,\
     "<awk '{print ($3+2*$5)/(2*($3+$4+$5)), sqrt(3)*$3/(2*($3+$4+$5))}' densitiesk2r4-0.5.dat" t 'r=4' with lines ls 8    
...
plot "<awk '{print ($3+2*$5)/(2*($3+$4+$5)), sqrt(3)*$3/(2*($3+$4+$5))}' densitiesk2r2-0.8.dat" t 'r=2' with lines ls 9,\
     "<awk '{print ($3+2*$5)/(2*($3+$4+$5)), sqrt(3)*$3/(2*($3+$4+$5))}' densitiesk2r4-0.8.dat" t 'r=4' with lines ls 8 
