...
set label '$m=0.8$' at 0.5, 0.8 center tc 'black' font ",16"
...
plot "<awk '{print ($3+2*$5)/(2*($3+$4+$5)), sqrt(3)*$3/(2*($3+$4+$5))}' densitiesk2r2-0.8.dat" t '$\alpha$=1.0' with lines ls 9,\
     "<awk '{print ($3+2*$5)/(2*($3+$4+$5)), sqrt(3)*$3/(2*($3+$4+$5))}' densitiesa3m8.dat" t '$\alpha$=0.3' with lines ls 8
