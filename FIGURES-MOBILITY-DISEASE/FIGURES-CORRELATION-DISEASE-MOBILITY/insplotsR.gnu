...
plot 'autocorrelation-safe.dat' u 1:2:3 with yerrorbars ls 1 t'l',\
     'autocorrelation-safe.dat' u 1:4:5 with yerrorbars ls 2 t'l',\
     'autocorrelation-safe.dat' u 1:6:7 with yerrorbars ls 3 t'l',\
     'autocorrelation-safe.dat' u 1:8:9 with yerrorbars ls 4 t'l',\
     'autocorrelation-safe.dat' u 1:10:11 with yerrorbars ls 5 t'l',\
     'autocorrelation-safe.dat' u 1:2 with lp ls 1 notitle,\
     'autocorrelation-safe.dat' u 1:4 with lp ls 2 notitle,\
     'autocorrelation-safe.dat' u 1:6 with lp ls 3 notitle,\
     'autocorrelation-safe.dat' u 1:8 with lp ls 4 notitle,\
     'autocorrelation-safe.dat' u 1:10 with lp ls 5 notitle
