...
plot	'statistics-M2.dat' u 1:($2-$8-$9-$10):30 with errorbars ls 1 t'0',\
	'statistics-M2.dat' u 1:($3+$8):31 with errorbars ls 3 t'1',\
	'statistics-M2.dat' u 1:($4+$9):32 with errorbars ls 4 t'2',\
	'statistics-M2.dat' u 1:($5+$10):33 with errorbars ls 7 t'3',\
	'statistics-M2.dat' u 1:($2-$8-$9-$10) with lp ls 1 notitle,\
	'statistics-M2.dat' u 1:($3+$8) with lp ls 3 notitle,\
	'statistics-M2.dat' u 1:($4+$9) with lp ls 4 notitle,\
	'statistics-M2.dat' u 1:($5+$10) with lp ls 7 notitle
