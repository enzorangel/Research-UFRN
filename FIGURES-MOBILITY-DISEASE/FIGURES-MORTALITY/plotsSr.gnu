...
set size 1.6, 1.0
set key at 0.65,14 font ",14"

plot 	'statistics.dat' u 1:($13*100):41 with errorbars ls 2 t'1',\
	'statistics.dat' u 1:($14*100):42 with errorbars ls 3 t'2',\
	'statistics.dat' u 1:($15*100):43 with errorbars ls 1 t'3',\
	'statistics.dat' u 1:($13*100) with lp ls 2 notitle,\
	'statistics.dat' u 1:($14*100) with lp ls 3 notitle,\
	'statistics.dat' u 1:($15*100) with lp ls 1 notitle
