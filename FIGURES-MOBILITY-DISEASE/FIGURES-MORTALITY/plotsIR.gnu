...
set size 1.6, 1.0
set key at 0.65,35 font ",14"

plot 	'statistics.dat' u 1:($18*100):46 with errorbars ls 2 t'1',\
	'statistics.dat' u 1:($19*100):47 with errorbars ls 3 t'2',\
	'statistics.dat' u 1:($20*100):48 with errorbars ls 1 t'3',\
	'statistics.dat' u 1:($18*100) with lp ls 2 notitle,\
	'statistics.dat' u 1:($19*100) with lp ls 3 notitle,\
	'statistics.dat' u 1:($20*100) with lp ls 1 notitle
