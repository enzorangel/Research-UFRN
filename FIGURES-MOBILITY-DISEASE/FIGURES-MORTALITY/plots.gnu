...
set size 1.6, 1.0
set key at 0.7,0.19 font ",14"
#set key above
#set key inside left center Left reverse
#set key left bottom Left title 'Legend' box 3
set tics nomirror

plot	'statistics.dat' u 1:($2-$8-$9-$10):30 with errorbars ls 1 t'0',\
	'statistics.dat' u 1:($3+$8):31 with errorbars ls 4 t'1',\
	'statistics.dat' u 1:($4+$9):32 with errorbars ls 7 t'2',\
	'statistics.dat' u 1:($5+$10):33 with errorbars ls 3 t'3',\
	'statistics.dat' u 1:($2-$8-$9-$10) with lp ls 1 notitle,\
	'statistics.dat' u 1:($3+$8) with lp ls 4 notitle,\
	'statistics.dat' u 1:($4+$9) with lp ls 7 notitle,\
