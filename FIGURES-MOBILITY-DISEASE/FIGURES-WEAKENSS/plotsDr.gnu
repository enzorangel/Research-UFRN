...
set size 1.6, 1.0
set key at 0.2,22 font ",14"

plot 	'statistics.dat' u (1-$1):($23*100):51 with errorbars ls 2 t'1',\
	'statistics.dat' u (1-$1):($24*100):52 with errorbars ls 3 t'2',\
	'statistics.dat' u (1-$1):($25*100):53 with errorbars ls 1 t'3',\
	'statistics.dat' u (1-$1):($23*100) with lp ls 2 notitle,\
	'statistics.dat' u (1-$1):($24*100) with lp ls 3 notitle,\
	'statistics.dat' u (1-$1):($25*100) with lp ls 1 notitle
