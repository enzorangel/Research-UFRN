...
set label 1 'social distancing' at 0.78, 0.4795 font ',15'
set label 2 'safeguard' at 0.04,0.4795 font ',15'
...
set origin 0, 1.0
set size 1.6, 1.3
set key at 0.2,0.498 font ",14"

plot 	0.50761 ls 9 notitle,\
	'statistics.dat' u (1.0-$1):18:46 with errorbars ls 1 t'1',\
	'statistics.dat' u (1.0-$1):19:47 with errorbars ls 2 t'2',\
	'statistics.dat' u (1.0-$1):20:48 with errorbars ls 3 t'3',\
	'statistics.dat' u (1.0-$1):21:49 with errorbars ls 4 t'4',\
	'statistics.dat' u (1.0-$1):22:50 with errorbars ls 5 t'5',\
	'statistics.dat' u (1.0-$1):18 with lp ls 1 notitle,\
	'statistics.dat' u (1.0-$1):19 with lp ls 2 notitle,\
	'statistics.dat' u (1.0-$1):20 with lp ls 3 notitle,\
	'statistics.dat' u (1.0-$1):21 with lp ls 4 notitle,\
	'statistics.dat' u (1.0-$1):22 with lp ls 5 notitle
