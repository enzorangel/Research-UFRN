...
set xl'$\sigma_i$' font ", 28" offset 0,-1.25,0
set yl'$\omega_i$' font ", 28" offset -2,0,0

set arrow 1 from 0.2, 0.274 to 0,0.274 linestyle 13
set arrow 2 from 0.8, 0.274 to 1,0.274 linestyle 14

set label 1 'social distancing' at -0.01,0.2725 font ',15'
set label 2 'safeguard' at 0.83,0.2725 font ',15'
