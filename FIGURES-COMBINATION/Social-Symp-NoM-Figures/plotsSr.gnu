...
set arrow 1 from 0.2, 0.018 to 0,0.018 linestyle 13
set arrow 2 from 0.8, 0.018 to 1,0.018 linestyle 14

set label 1 'social distancing' at -0.01, 0.0145 font ',15'
set label 2 'safeguard' at 0.83,0.0145 font ',15'
...
set origin 0, 1.0
set size 1.6, 1.3
set key at 0.2,0.09 font ",14"
set tics nomirror

plot 	0.0533171 ls 9 notitle,\
	'statistics.dat' u (1.0-$1):13:41 with errorbars ls 1 t'1',\
	'statistics.dat' u (1.0-$1):14:42 with errorbars ls 2 t'2',\
	'statistics.dat' u (1.0-$1):15:43 with errorbars ls 3 t'3',\
	'statistics.dat' u (1.0-$1):16:44 with errorbars ls 4 t'4',\
	'statistics.dat' u (1.0-$1):17:45 with errorbars ls 5 t'5',\
	'statistics.dat' u (1.0-$1):13 with lp ls 1 notitle,\
	'statistics.dat' u (1.0-$1):14 with lp ls 2 notitle,\
	'statistics.dat' u (1.0-$1):15 with lp ls 3 notitle,\
	'statistics.dat' u (1.0-$1):16 with lp ls 4 notitle,\
	'statistics.dat' u (1.0-$1):17 with lp ls 5 notitle
