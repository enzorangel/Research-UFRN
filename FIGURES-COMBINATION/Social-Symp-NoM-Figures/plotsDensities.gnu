...
set style line 6 lc rgb '#D81B60' dt 2 lw 4.5 pt 6 ps 3.0 #(empty space)
set style line 7 lc rgb '#1E88E5' dt 2 lw 4.5 pt 6 ps 3.0 #(species 6)
set style line 8 lc rgb '#fcbdce' dt 2 lw 4.5 pt 6 ps 3.0 #(species 7)
set style line 9 lc rgb '#004D40' dt 2 lw 4.5 pt 6 ps 3.0 #(species 8)
set style line 10 lc rgb '#F5FF00' dt 2 lw 4.5 pt 6 ps 3.0 #(species 9)
set style line 11 lc rgb '#999999' pt 6 #(species 10)
...
set label 3 '$\sigma$' at 0.47,-0.03 font ", 28"
set yl'$\rho_i$' font ", 28" offset -3,0,0
...
set label 1 'social distancing' at -0.035, -0.03 font ',15'
set label 2 'safeguard' at 0.81,-0.03 font ',15'
