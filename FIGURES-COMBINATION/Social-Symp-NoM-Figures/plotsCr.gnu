...
set xl'$Social$' font ", 16" offset 0,-1.25,0
set yl'$\tau_i$' font ", 19" offset -3,0,0

set arrow 1 from 0.2, 0.0803 to 0,0.0803 linestyle 13
set arrow 2 from 0.8, 0.0803 to 1,0.0803 linestyle 14

set label 1 'social distancing' at -0.01, 0.080 font ',12'
set label 2 'safeguard' at 0.83,0.080 font ',12'
...
plot 	'statistics.dat' u 1:28:56 with errorbars ls 1 t'Cure rate',\
	'statistics.dat' u 1:28 with lp ls 1 notitle
