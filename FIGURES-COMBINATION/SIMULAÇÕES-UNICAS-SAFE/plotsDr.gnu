...
set yl'$\omega_i$' font ", 19" offset -3,0,0

set arrow 1 from 0.2, 0.271 to 0,0.271 linestyle 13
set arrow 2 from 0.8, 0.271 to 1,0.271 linestyle 14

set label 1 'social distancing' at -0.01,0.2695 font ',12'
set label 2 'safeguard' at 0.83,0.2695 font ',12'
