...
set arrow 1 from 0.2, 0.023 to 0,0.023 linestyle 13
set arrow 2 from 0.8, 0.023 to 1,0.023 linestyle 14

set label 1 'Social Distance' at 0.79, 0.02 font ',15'
set label 2 'Safeguard' at 0.03,0.02 font ',15'
...
set origin 0, 1.0
set size 1.6, 1.3
set key at 0.3,0.09 font ",14"
set tics nomirror

plot 	'statistics-0.dat' u (1.0-$1):13:41 with errorbars ls 1 t'$\eta=0.00$',\
	'statistics-25.dat' u (1.0-$1):13:41 with errorbars ls 2 t'$\eta=0.25$',\
	'statistics-50.dat' u (1.0-$1):13:41 with errorbars ls 3 t'$\eta=0.50$',\
	'statistics-75.dat' u (1.0-$1):13:41 with errorbars ls 4 t'$\eta=0.75$',\
	'statistics-100.dat' u (1.0-$1):13:41 with errorbars ls 5 t'$\eta=1.00$',\
	'statistics-0.dat' u (1.0-$1):13 with lp ls 1 notitle,\
	'statistics-25.dat' u (1.0-$1):13 with lp ls 2 notitle,\
	'statistics-50.dat' u (1.0-$1):13 with lp ls 3 notitle,\
	'statistics-75.dat' u (1.0-$1):13 with lp ls 4 notitle,\
	'statistics-100.dat' u (1.0-$1):13 with lp ls 5 notitle,\
