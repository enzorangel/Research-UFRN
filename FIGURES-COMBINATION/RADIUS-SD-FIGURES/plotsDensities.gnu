...
set xl'$Radius$' font ", 16" offset 0,-1.25,0
...
set origin 0, 1.0
set size 1.437, 1.0
set key at 5.95,0.2 font ",14"

plot 	'statistics.dat' u 1:($2-$8-$9-$10-$11-$12):30 with errorbars ls 11 t'0',\
	'statistics.dat' u 1:3:31 with errorbars ls 1 t'1h',\
