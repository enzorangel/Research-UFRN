...
set style line 3 lc rgb 'orange' lt 0 lw 4.5 pt 7 ps 1
...
plot 'statistics-std.dat' u 1:2 with lp ls 1 t'std',\
     'statistics-a0p1.dat' u 1:2 with lp ls 3 t'$\alpha = 0.1$',\
     'statistics-a0p2.dat' u 1:2 with lp ls 5 t'$\alpha = 0.2$',\
      'statistics-a0p3.dat' u 1:2 with lp ls 2 t'$\alpha = 0.3$',\
      'statistics-a0p6.dat' u 1:2 with lp ls 4 t'$\alpha = 0.6$',\
      'statistics-k2.dat' u 1:2 with lp ls 6 t'$\alpha = 1.0$'
